...
export async function getStaticProps() {
    const res = await fetch('https://thisisbac.herokuapp.com/api/v1/account/62767b99227d0c0020633f66')
...
const ProfileCard = ({users} : any) => {
    ...
    return(
        <div className="relative pt-14 bg-black text-white shadow rounded overflow-hidden">
            ...
            <h3 className="font-medium"> {users.namespace} </h3>
