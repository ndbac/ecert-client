  ...
  return (
    ...
    <div className="relative pt-48 w-2/3 ml-auto">
      <div className="absolute top-0 left-0 -ml-64 rounded-full h-20 md:h-160 w-80 md:w-160">
        <Image className="object-contain transform scale-200" src={ShadowBlueFull} alt=""/>
      </div>
    ...
    <div className="relative container mx-auto px-4 pb-24 lg:pb-64">
      <div className="flex flex-wrap -mx-4">
        <div className="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
          <h2 className="md:max-w-md mx-auto text-2xl sm:text-4xl md:text-6xl text-white uppercase font-heading">Take care of your performance every day</h2>
        </div>
        <div className="w-full lg:w-1/2 px-4">
          <div className="md:max-w-md mx-auto">
            <p className="mb-20 max-w-sm sm:text-xl font-semibold text-white">Take care to develop resources continually and integrity them with previous projects.</p>
            <div className="flex px-8 py-4 bg-black rounded-full border border-white">
              <input className="w-full pr-4 bg-transparent text-white placeholder-white outline-none" type="email" placeholder="Type your e-mail"/>
              <button className="flex items-center text-yellow-300 hover:text-yellow-400">
                <span className="mr-2">Go</span>
                <svg className="mt-1" width="16" height="8" viewBox="0 0 16 8" fill="none" xmlns="http://www.w3.org/2000/svg">
