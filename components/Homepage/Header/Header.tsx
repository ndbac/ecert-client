...
import { DEFAULT_EMAIL_ADDRESS, SUBSCRIBE_EMAIL_SUBJECT } from "../../../utils/defaultValues";
        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full lg:w-1/2 px-4">
            <div className="md:max-w-md mx-auto">
              ...
              <form onSubmit={formik.handleSubmit} className="flex px-8 py-4 bg-black rounded-full border border-white">
                <input 
                ...
                />
                <button type="submit" className="flex items-center text-yellow-300 hover:text-yellow-400">
