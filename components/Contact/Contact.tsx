      ...
      <div className="flex px-6 md:px-12 flex-wrap items-center justify-center">
        <div className="m-auto">
          <div className="text-center px-4 relative pb-10">
            ...
            <div className="text-white md:text-gray-500 text-xl">
          ...
          <form onSubmit={formik.handleSubmit} className="px-4 pt-4">
            <div className="text-white text-3xl text-center pt-6 pb-10 font-semibold">
              Send us a message!
            </div>
            {serverErr && (
              <div className="text-yellow-400 font-semibold text-xl text-center pb-8">
            ...
            <div>
              <div className="flex flex-wrap justify-between">
                <div className="w-full lg:w-auto pr-2">
                  <div className="text-lg text-white md:text-gray-500 pl-4 pb-2">
                    First Name:{' '}
                  </div>
                  <input
                    type="text"
                    className="w-full lg:w-96 mb-4 py-4 px-10 bg-black rounded-full border text-white outline-none placeholder-white"
              ...
              <div>
                <label
                  className="text-lg text-white md:text-gray-500 pl-4 pb-2"
                  htmlFor="email"
                >
                  Email:{' '}
                </label>
                <input
                  type="text"
                  className="w-full mb-4 py-4 px-10 bg-black rounded-full border text-white outline-none placeholder-white"
              ...
              <div>
                ...
                <textarea
                  className="w-full mb-4 py-4 px-10 bg-black rounded-md border text-white outline-none placeholder-white"
              ...
              <div className="pt-6">
                <button
                  ...
                  className={
                    loading
                      ? 'px-6 py-4 text-sm font-semibold bg-yellow-600 rounded transition duration-200'
                      : 'px-6 py-4 text-sm font-semibold bg-yellow-400 hover:bg-yellow-600 rounded transition duration-200'
                  }
                >
                  <span className="mr-2">
      ...
      <div className="text-center pt-20 relative">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 right-1/2 py-6 px-6 bg-black border overflow-hidden">
          <div className="md:block hidden">
            <h3 className="mb-1 text-xs text-gray-500 font-semibold uppercase tracking-widest">
              Address
            </h3>
